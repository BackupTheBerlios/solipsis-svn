...
#AVATARS
    ...
    ("solipsis/services/avatar/po/ja/LC_MESSAGES", 
        glob.glob("solipsis/services/avatar/po/ja/LC_MESSAGES/*.*")),
    ("solipsis/services/avatar/po/sl/LC_MESSAGES", 
        glob.glob("solipsis/services/avatar/po/sl/LC_MESSAGES/*.*")),
#CHAT
    ...
    ("solipsis/services/chat/po/ja/LC_MESSAGES", 
        glob.glob("solipsis/services/chat/po/ja/LC_MESSAGES/*.*")),
    ("solipsis/services/chat/po/sl/LC_MESSAGES", 
        glob.glob("solipsis/services/chat/po/sl/LC_MESSAGES/*.*")),
#PROFILE
...
# End services files
    ...
    ("po/ja/LC_MESSAGES", 
        ["po/ja/LC_MESSAGES/solipsis.mo",
        "po/ja/LC_MESSAGES/solipsis.po"]),
    ("po/sl/LC_MESSAGES", 
        ["po/sl/LC_MESSAGES/solipsis.mo",
        "po/sl/LC_MESSAGES/solipsis.po"])]
