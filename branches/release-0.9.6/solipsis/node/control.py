...
class RemoteControl(object):
    ...
    def remote_JumpNearPeer(self, connect_id, addr_info, peer_id):
        """
        Jump near another peer.
        """
        self._CheckConnectId(connect_id)
        address = Address.FromStruct(addr_info)
        self.state_machine.JumpNear(address, peer_id)
        return True
    ...
    def event_ChangedId(self, old_peer_id, peer):
        self._AddNotif("CHANGED_ID", (old_peer_id, peer.ToStruct()))
