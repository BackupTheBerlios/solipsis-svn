...
class Locating(State):
    ...
    """
    expected_peer_messages = [
        'SERVICEDATA', 'MIDDLEMAN', 'NEAREST', 'BEST', 'HEARTBEAT', 'SUGGEST']
...
class Scanning(State):
    ...
    """
    expected_peer_messages = [
        'SERVICEDATA', 'MIDDLEMAN', 'NEAREST', 'BEST', 'AROUND', 'HEARTBEAT', 'FINDNEAREST', 'SUGGEST']
...
class EarlyConnecting(State):
    ...
    """
    expected_peer_messages = [
        'SERVICEDATA', 'MIDDLEMAN', 'HELLO', 'CONNECT', 'CLOSE', 'HEARTBEAT', 'META', 'QUERYMETA']
