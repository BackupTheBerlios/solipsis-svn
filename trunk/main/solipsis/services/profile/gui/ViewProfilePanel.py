...
class ViewProfilePanel(wx.Panel):
    def __init__(self, *args, **kwds):
        # begin wxGlade: ViewProfilePanel.__init__
        kwds["style"] = wx.TAB_TRAVERSAL
        wx.Panel.__init__(self, *args, **kwds)
        self.sizer_10_staticbox = wx.StaticBox(self, -1, _("Matching profiles"))
    ...
    def __set_properties(self):
        # begin wxGlade: ViewProfilePanel.__set_properties
        pass
        # end wxGlade

    def __do_layout(self):
        # begin wxGlade: ViewProfilePanel.__do_layout
        sizer_10 = wx.StaticBoxSizer(self.sizer_10_staticbox, wx.VERTICAL)
        sizer_10.Add(self.matching_list, 1, wx.EXPAND, 0)
