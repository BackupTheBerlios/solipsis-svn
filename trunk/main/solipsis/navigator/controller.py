...
class XMLRPCController(Controller):
    ...
    def createNode(self, pseudo=''):
        ...
        args = ['python', 'solipsis/node/main.py']
...
class DummyController(Controller):
    ...
    def connect(self):
        ...
        from solipsis.node.entity import Position
        nodeinfo = ControlEvent('NODEINFO')
        nodeinfo.addArg('Id', 'slp:node_dummycontroller')
        nodeinfo.addArg('Position', Position(12,16))
        ...
        newEvent.addArg('Position', Position(88,36))
    ...
    def OnTimer(self):
        ...
        newEvent.addArg('Position', Position(-20,126))
        newEvent.addArg('Awareness-Radius', 10)
